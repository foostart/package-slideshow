...
<table class="table table-hover">
    ...
    <thead>
        <tr style="height: 50px;">
            ...
            <th class="hidden-xs" style='width:{{ $withs['name'] }}'>{!! trans($plang_admin.'.columns.name-style') !!}
    ...
    <tbody>
        @foreach($items as $item)
            ...
            <tr>
                ...
                <td>
                    <!--edit-->
                    <a href="{!! URL::route('styles.edit', [   'id' => $item->id,
                                                                '_token' => csrf_token()
                                                            ])
                            !!}">
                    ...
                    <!--copy-->
                    <a href="{!! URL::route('styles.copy',[    'cid' => $item->id,
                                                                '_token' => csrf_token(),
                                                            ])
                             !!}"
                        class="margin-left-5">
                    ...
                    <!--delete-->
                    <a href="{!! URL::route('styles.delete',[  'id' => $item->id,
                                                                '_token' => csrf_token(),
                                                              ])
                             !!}"
